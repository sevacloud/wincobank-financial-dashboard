        ...
        import( 'chart.js/auto' ).then( ( { default: Chart } ) => {
            ...
            chartRef.current = new Chart( canvasRef.current, {
                ...
                data: {
                    ...
                    datasets: [
                        {
                            label: __( 'Income', 'wincobank-dashboard' ),
                        ...
                        {
                            label: __( 'Expenditure', 'wincobank-dashboard' ),
    ...
    return (
        <div className="wb-card">
            <h3 className="wb-card__title">
                { __( 'Income vs Expenditure — All Accounts', 'wincobank-dashboard' ) }
            </h3>
            <div className="wb-chart-wrap">
                <canvas
                    ref={ canvasRef }
                    role="img"
                    aria-label={ __( 'Line chart: monthly combined income vs expenditure', 'wincobank-dashboard' ) }
                />
            </div>
        </div>
    );
...
function AccountBalancesChart( { months, data } ) {
    ...
    return (
        <div className="wb-card">
            <h3 className="wb-card__title">
                { __( 'Net Balance by Account — Monthly', 'wincobank-dashboard' ) }
            </h3>
            <div className="wb-chart-wrap">
                <canvas
                    ref={ canvasRef }
                    role="img"
                    aria-label={ __( 'Clustered bar chart: monthly net balance per account', 'wincobank-dashboard' ) }
                />
            </div>
        </div>
    );
...
function SummaryTable( { months, data } ) {
    ...
    return (
        <div className="wb-card">
            <h3 className="wb-card__title">{ __( 'Monthly Breakdown', 'wincobank-dashboard' ) }</h3>
            <div className="wb-table-wrap">
                <table className="wb-table">
                    <thead>
                        <tr>
                            <th rowSpan={ 2 }>{ __( 'Month', 'wincobank-dashboard' ) }</th>
                            { ACCOUNT_KEYS.map( ( k ) => (
