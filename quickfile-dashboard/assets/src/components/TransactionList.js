            ...
            <div className="wb-drawer" role="dialog" aria-modal="true" aria-label={ accountLabel }>
                ...
                <div className="wb-drawer__header">
                    <div>
                        ...
                        { meta.CurrentBalance != null && (
                            <div className="wb-drawer__subtitle">
                                { __( 'Current balance:', 'quickfile-dashboard' ) }
                                { ' ' }
                    ...
                    <button
                        ...
                        onClick={ onClose }
                        aria-label={ __( 'Close', 'quickfile-dashboard' ) }
                    >✕</button>
                </div>

                <div className="wb-drawer__controls">
                    <label>
                        { __( 'From', 'quickfile-dashboard' ) }
                        <input type="date" value={ from } onChange={ ( e ) => setFrom( e.target.value ) } />
                    </label>
                    <label>
                        { __( 'To', 'quickfile-dashboard' ) }
                    ...
                    <button
                        ...
                        disabled={ loading }
                    >
                        { loading ? __( 'Loading…', 'quickfile-dashboard' ) : __( 'Load', 'quickfile-dashboard' ) }
                    </button>
                </div>
                            ...
                            <table className="wb-table wb-table--txn">
                                <thead>
                                    <tr>
                                        ...
                                        <th>{ __( 'Reference', 'quickfile-dashboard' ) }</th>
                                        <th className="wb-num">{ __( 'Amount',  'quickfile-dashboard' ) }</th>
                                        <th className="wb-num">{ __( 'Balance', 'quickfile-dashboard' ) }</th>
                                    </tr>
                                </thead>
                                <tbody>
